...
def main():
    ...
    print('defense_level: ', defense_level)
    ...
    model_dir = '{}/{}/{}/{}/'.format(params['model_dir'], attack, params['defense'], defense_level)
    ...
    if params['argmaxed']:
        ...
        model_dir = '{}/{}/{}/{}_noargmax/'.format(params['model_dir'], attack, params['defense'], defense_level)
    ...
    model = zoo.get_net(model_name, modelfamily, pretrained, dataset_name, num_classes=num_classes)
    ...
    for b in budgets:
        ...
        _, final_test_acc = model_utils.train_model(model, model_dir, transferset, testset=testset, criterion_train=criterion_train,
                                checkpoint_suffix=checkpoint_suffix, device=device, optimizer=optimizer, **params)

    print('final test acc: {}'.format(final_test_acc))
    # Store arguments
